package net.codecraft.mccourse.blocks.custom.crops;
...
public class TurnipCrop extends CropBlock {
    ...
    public TurnipCrop(AbstractBlock.Settings settings) {
        super(settings);
    }
