package net.codecraft.mccourse.fluid;
...
public abstract class HoneyFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return Fluids.HONEY_FLOWING;
    }

    public Fluid getStill() {
        return Fluids.HONEY_STILL;
    }

    public Item getBucketItem() {
        return ModItem.HONEY_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlock.HONEY_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == Fluids.HONEY_STILL || fluid == Fluids.HONEY_FLOWING;
    }
